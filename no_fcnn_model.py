"""Local zero-FCNN model: LightGBM + XGBoost + Random Forest -> GBM.

The original feature, label, scaling and search definitions are retained.
Only tree learners are imported and constructed in this module.
"""
...
def preprocess_data(file_path):
    ...
    # Historical label: current-day vs previous-day GOLD direction.
